...
######## CFLAGS
CFLAGS      = /c /MP /GS- /Qpar /GL /analyze- /W4 /Gy /Zc:wchar_t /Zi /Gm- /Ox /Zc:inline /fp:precise /DWIN32 /DWIN64 /DNDEBUG /D_UNICODE /DUNICODE /fp:except- /errorReport:none /GF /WX /Zc:forScope /GR- /Gd /Oy /Oi /MT /EHa /nologo /std:c++latest
CFLAGS      += /I"$(SRCPATH)"
...
MakeFile_ARGVS := \
    ...
    LDFLAGS="$(LDFLAGS)" LDFLAGS_CONSOLE="$(LDFLAGS_CONSOLE)" LDFLAGS_WINDOWS="$(LDFLAGS_WINDOWS)" \
